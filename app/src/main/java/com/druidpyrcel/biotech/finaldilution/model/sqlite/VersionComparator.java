 ...
 * <code>..._updated_10_11</code>) from sing the <em>incorrect</em>
...
class VersionComparator implements Comparator<String> {
     ...
     * @throws DataProvider.SQLiteAssetException thrown if the strings are not in the correct upgrade
     *                                           script format of:
    ...
    public int compare(String file0, String file1) {
        ...
        if (!m0.matches()) {
            ...
            throw new DataProvider.SQLiteAssetException("Invalid upgrade script file");
        }
